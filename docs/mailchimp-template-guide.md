...
| 區域 | 內容來源 | 更新方式 |
|------|---------|---------|
| 00-Header | 每期不同 | 編輯手動修改標題、日期 |
| 01 ~ 07 (系統區域) | 系統自動產生 | 編輯複製系統產出的 HTML 貼入 |
...
系統會自動產出 01-Content 到 07-Poll 區塊的 HTML 內容。
...
是的。目前的工作流程是：
1. 系統產出當期電子報 HTML（01 ~ 07 區塊）
2. 編輯複製該 HTML
3. 在 Mailchimp campaign 編輯器中貼入對應位置
